"""Definition of Dception model, variant of the Xception with
a customized padding (based on local differences, hence Dception!).

Usage:
  with slim.arg_scope(dception.dception_arg_scope()):
    outputs, end_points = dception.dception(inputs)
@@dception
"""
...
from nets.custom_layers import separable_convolution2d_diffpad
...
def dception(inputs,
    ...
    with tf.variable_scope(scope, 'dception', [inputs]):
        # Block 1.
        end_point = 'block1'
...
# =========================================================================== #
def dception_keras_arg_scope(hdf5_file, weight_decay=0.00001):
